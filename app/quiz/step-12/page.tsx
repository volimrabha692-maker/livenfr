  ...
  return (
    ...
    <QuizLayout step={9} totalSteps={26}>
      ...
      <header className="w-full px-6 py-4 flex justify-between items-center absolute top-0 left-0 right-0 bg-[#f5f3f0] z-10">
        ...
        <span className="text-gray-600 text-sm font-medium">9/26</span> {/* Etapa atualizada */}
      </header>
      ...
      <main className="flex flex-col items-center justify-center px-3 pt-1 pb-2 max-w-2xl mx-auto mt-4">
        ...
        <div className="text-center space-y-3 mb-12">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
            I often find it challenging to make a decision
          </h1>
              ...
              return (
                <div key={option.value} className="flex flex-col items-center gap-2 flex-1 text-center">
                  <button
                    ...
                    // Estilos do botão unificados com o padrão da Step10 e 11
