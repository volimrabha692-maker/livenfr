...
function Step23Content() {
  ...
  const options = [
    { text: "Se réveiller fatigué(e)", icon: BatteryCharging },
    { text: "Se réveiller pendant la nuit", icon: Moon },
    { text: "Qualité de sommeil réduite", icon: BarChart2 },
    { text: "Difficulté à s'endormir", icon: Bed },
    { text: "Se réveiller plus tôt que prévu", icon: Timer },
    { text: "Je dors bien", icon: ThumbsUp },
  ]

  return (
    // Utiliser QuizLayout pour la barre de progression, maintenant à l'étape 20/26
      ...
      <main className="flex flex-col items-center justify-center px-3 pt-1 pb-2 max-w-2xl mx-auto mt-4">
        <div className="text-center space-y-2 mb-12">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800">
            Y a-t-il quelque chose que vous voulez améliorer
            <br />
