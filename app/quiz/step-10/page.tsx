    ...
    <QuizLayout step={7} totalSteps={26}>
      ...
      <header className="w-full px-6 py-4 flex justify-between items-center absolute top-0 left-0 right-0 bg-[#f5f3f0] z-10">
        ...
        <div className="flex items-center gap-2">
          {/* O ícone central padrão pode ser inserido aqui se desejado */}
        </div>
        <span className="text-gray-600 text-sm font-medium">7/26</span> {/* Etapa atualizada */}
      </header>
      ...
      <main className="flex flex-col items-center justify-center px-3 pt-1 pb-2 max-w-2xl mx-auto mt-4">
        ...
        {/* 5. A escala de avaliação única da página, agora dentro do layout padrão */}
